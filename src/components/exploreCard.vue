...
<template>
  <div class="exploreCardContainer">
    <div class="exploreCardMain">
      <div class="exploreCard"></div>
      <div class="data">
        <div class="img"></div>
        <div class="text">
...
.exploreCardMain:hover .card_back {
  margin-top: -5.9em;
  margin-left: 0em;
  scale: 1.1;
  height: 15.25em;
...
.exploreCardMain:hover .likes {
  margin-top: 0.5em;
  opacity: 1;
}

.exploreCardMain:hover .comments {
  margin-top: 0.5em;
  opacity: 1;
}

.exploreCardMain:hover .views {
  margin-top: 0.5em;
  opacity: 1;
}
...
.exploreCardButton::after {
  content: '(Hold Me)';
  opacity: 0;
  position: absolute;
}

.exploreCardButton::before {
  content: '∞';
  font-size: 3.5em;
  position: absolute;
  opacity: 0;
...
.exploreCardButton:active::before {
  color: white;
  opacity: 1;
}
</style>
